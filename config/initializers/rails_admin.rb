# RailsAdmin config file. Generated on December 09, 2013 13:29
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Bookloop', 'Admin']
  ...
  # config.excluded_models = ['Acomment', 'Admin', 'Book', 'Comment', 'Commentary', 'Discussion', 'Follow', 'Link', 'Review', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Acomment', 'Admin', 'Book', 'Comment', 'Commentary', 'Discussion', 'Follow', 'Link', 'Review', 'User']
  ...
  # config.model 'Acomment' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your acomment.rb model definition
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your commentary.rb model definition
  ...
  # config.model 'Discussion' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your discussion.rb model definition
